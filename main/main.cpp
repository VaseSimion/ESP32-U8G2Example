...
#include "u8g2.h"    //This library needs to be cloned in the components folder from https://github.com/olikraus/u8g2 (The component folder is at the same level as main folder)
#include "esp_log.h"
...
void u8g2_display_init(u8g2_t *pu8g2) {
    ...
    u8g2_SetFont(pu8g2, u8g2_font_8x13B_tr);  // Set font
    u8g2_DrawStr(pu8g2, 0, 15, "Hello World!"); // Draw text
    u8g2_SendBuffer(pu8g2);       // Transfer buffer to display
}
...
extern "C" void app_main(void)
{
    ...
    while(1){
        ...
        u8g2_DrawStr(&u8g2, 0, 30, "Run no. ");
        sprintf(number_str, "%3d", i%999);
        u8g2_DrawStr(&u8g2, 60, 30, number_str);
